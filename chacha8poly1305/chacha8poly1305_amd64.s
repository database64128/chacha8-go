...
#define TT3 CC3
// ChaCha8 constants
DATA ·chacha8Constants<>+0x00(SB)/4, $0x61707865
DATA ·chacha8Constants<>+0x04(SB)/4, $0x3320646e
DATA ·chacha8Constants<>+0x08(SB)/4, $0x79622d32
DATA ·chacha8Constants<>+0x0c(SB)/4, $0x6b206574
DATA ·chacha8Constants<>+0x10(SB)/4, $0x61707865
DATA ·chacha8Constants<>+0x14(SB)/4, $0x3320646e
DATA ·chacha8Constants<>+0x18(SB)/4, $0x79622d32
DATA ·chacha8Constants<>+0x1c(SB)/4, $0x6b206574
// <<< 16 with PSHUFB
...
GLOBL ·chacha8Constants<>(SB), (NOPTR+RODATA), $32
...
// ----------------------------------------------------------------------------
// func chacha8Poly1305Open(dst, key, src, ad []byte) bool
TEXT ·chacha8Poly1305Open(SB), 0, $288-97
...
openSSEPreparePolyKey:
	...
	PADDL ·chacha8Constants<>(SB), A0; PADDL state1Store, B0
...
openSSEMainLoop:
	...
	MOVO ·chacha8Constants<>(SB), A0; MOVO state1Store, B0; MOVO state2Store, C0; MOVO ctr3Store, D0; PADDL ·sseIncMask<>(SB), D0
	...
	// There are 4 ChaCha8 iterations of 2QR each, so for 0 iterations we hash 2 blocks, and for the remaining 4 only 1 block - for a total of 4
	MOVQ $4, itr1
	MOVQ inp, itr2
...
openSSEInternalLoop:
	...
	// Add in the state
	PADDD ·chacha8Constants<>(SB), A0; PADDD ·chacha8Constants<>(SB), A1; PADDD ·chacha8Constants<>(SB), A2; PADDD ·chacha8Constants<>(SB), A3
...
openSSE128:
	...
	MOVOU ·chacha8Constants<>(SB), A0; MOVOU (1*16)(keyp), B0; MOVOU (2*16)(keyp), C0; MOVOU (3*16)(keyp), D0
	MOVO  A0, A1; MOVO B0, B1; MOVO C0, C1; MOVO D0, D1; PADDL ·sseIncMask<>(SB), D1
	MOVO  A1, A2; MOVO B1, B2; MOVO C1, C2; MOVO D1, D2; PADDL ·sseIncMask<>(SB), D2
...
openSSE128InnerCipherLoop:
	...
	// A0|B0 hold the Poly1305 32-byte key, C0,D0 can be discarded
	PADDL ·chacha8Constants<>(SB), A0; PADDL ·chacha8Constants<>(SB), A1; PADDL ·chacha8Constants<>(SB), A2
...
openSSETail64:
	...
	MOVO ·chacha8Constants<>(SB), A0; MOVO state1Store, B0; MOVO state2Store, C0; MOVO ctr3Store, D0; PADDL ·sseIncMask<>(SB), D0; MOVO D0, ctr0Store
	XORQ itr2, itr2
	MOVQ inl, itr1
	CMPQ itr1, $16
...
openSSETail64LoopB:
	...
	PADDL ·chacha8Constants<>(SB), A0; PADDL state1Store, B0; PADDL state2Store, C0; PADDL ctr0Store, D0
...
openSSETail128:
	...
	MOVO ·chacha8Constants<>(SB), A1; MOVO state1Store, B1; MOVO state2Store, C1; MOVO ctr3Store, D1; PADDL ·sseIncMask<>(SB), D1; MOVO D1, ctr0Store
...
openSSETail128LoopB:
	...
	PADDL ·chacha8Constants<>(SB), A0; PADDL ·chacha8Constants<>(SB), A1
...
openSSETail192:
	...
	MOVO ·chacha8Constants<>(SB), A2; MOVO state1Store, B2; MOVO state2Store, C2; MOVO ctr3Store, D2; PADDL ·sseIncMask<>(SB), D2; MOVO D2, ctr0Store
...
// ----------------------------------------------------------------------------
// ------------------------- AVX2 Code ----------------------------------------
chacha8Poly1305Open_AVX2:
	VZEROUPPER
	VMOVDQU ·chacha8Constants<>(SB), AA0
...
openAVX2PreparePolyKey:
	...
	VPADDD ·chacha8Constants<>(SB), AA0, AA0
...
openAVX2MainLoop:
	...
	VMOVDQU ·chacha8Constants<>(SB), AA0; VMOVDQA AA0, AA1; VMOVDQA AA0, AA2; VMOVDQA AA0, AA3
...
openAVX2InternalLoop:
	...
	VPADDD  ·chacha8Constants<>(SB), AA0, AA0; VPADDD ·chacha8Constants<>(SB), AA1, AA1; VPADDD ·chacha8Constants<>(SB), AA2, AA2; VPADDD ·chacha8Constants<>(SB), AA3, AA3
...
openAVX2320InnerCipherLoop:
	...
	VMOVDQA ·chacha8Constants<>(SB), TT0
...
openAVX2Tail128:
	// Need to decrypt up to 128 bytes - prepare two blocks
	VMOVDQA ·chacha8Constants<>(SB), AA1
...
openAVX2Tail128LoopB:
	...
	VPADDD     ·chacha8Constants<>(SB), AA1, AA1
...
openAVX2Tail256:
	// Need to decrypt up to 256 bytes - prepare four blocks
	VMOVDQA ·chacha8Constants<>(SB), AA0; VMOVDQA AA0, AA1
...
openAVX2Tail256HashEnd:
	VPADDD     ·chacha8Constants<>(SB), AA0, AA0; VPADDD ·chacha8Constants<>(SB), AA1, AA1
...
openAVX2Tail384:
	...
	VMOVDQA ·chacha8Constants<>(SB), AA0; VMOVDQA AA0, AA1; VMOVDQA AA0, AA2
...
openAVX2Tail384HashEnd:
	VPADDD     ·chacha8Constants<>(SB), AA0, AA0; VPADDD ·chacha8Constants<>(SB), AA1, AA1; VPADDD ·chacha8Constants<>(SB), AA2, AA2
...
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
// func chacha8Poly1305Seal(dst, key, src, ad []byte)
TEXT ·chacha8Poly1305Seal(SB), 0, $288-96
	// For aligned stack access
	MOVQ SP, BP
	ADDQ $32, BP
	ANDQ $-32, BP
...
sealAVX2IntroLoop:
	...
	VMOVDQA ·chacha8Constants<>(SB), AA0; VMOVDQA AA0, AA1; VMOVDQA AA0, AA2; VMOVDQA AA0, AA3
	VMOVDQA state1StoreAVX2, BB0; VMOVDQA BB0, BB1; VMOVDQA BB0, BB2; VMOVDQA BB0, BB3
	VMOVDQA state2StoreAVX2, CC0; VMOVDQA CC0, CC1; VMOVDQA CC0, CC2; VMOVDQA CC0, CC3
	VMOVDQA ctr3StoreAVX2, DD0
...
sealAVX2Tail128:
	...
	VMOVDQA ·chacha8Constants<>(SB), AA0
...
sealAVX2Tail128LoopB:
	...
	VPADDD ·chacha8Constants<>(SB), AA0, AA1
...
sealAVX2Tail256:
	...
	// If we got here after the main loop - there are 512 encrypted bytes waiting to be hashed
	// If we got here before the main loop - there are 448 encrpyred bytes waiting to be hashed
	VMOVDQA ·chacha8Constants<>(SB), AA0; VMOVDQA ·chacha8Constants<>(SB), AA1
